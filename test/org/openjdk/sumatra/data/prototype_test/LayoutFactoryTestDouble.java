...
public class LayoutFactoryTestDouble extends TestCommon {
    ...
    public static class IP1 {
        ...
        double a;
        double b;
        IP1(double a, double b){this.a = a; this.b = b; }
        public Double a() { return a; }
        public Double b() { return b; }
        public static IP1 valueOf(Double a, Double b) {
    ...
    public static class IP2 {
        double a;
        Double[] b;
        IP2(double a, Double[] b){
            this.a = a; this.b = b; }
        public Double a() { return a; }
        public Double[] b() { return b; }
        public static IP2 valueOf(Double a, Double[] b) {
    ...
    public static class IP3 {
        double a;
        double b;
        IP3(double a, double b){this.a = a; this.b = b; }
        public double a() { return a; }
        public Double b() { return b; }
        public static IP3 valueOf(double a, Double b) {
    ...
    public void testArray() {
        ...
        Layout<Double[]> ar_layout = lf.array(Double.class, 12);
        assertEquals("Size of array", 12 * LayoutFactory.DS, ar_layout.byteOrBitSize());
        assertEquals("Align of array", LayoutFactory.DA, ar_layout.byteAlign());

        Location<Double[]> ar_loc = ar_layout.allocate();
     ...
     * @param ar_loc
     */
    private void testArray_common(Location<Double[]> ar_loc) {
        for (int i = 0; i < 12; i++) {
            Location<Double> i_loc = ar_loc.loc(i);
            assertEquals("Location of array element", i_loc.addr(),
                    ar_loc.addr() + i * LayoutFactory.DS);
        }
    ...
    public void testTuple() {
        ...
        assertEquals("Size of tuple", 2 * LayoutFactory.DS, ip1_layout.byteOrBitSize());
        assertEquals("Align of tuple", LayoutFactory.DA, ip1_layout.byteAlign());
    ...
    public void testTupleWithArray() {
        ...
        assertEquals("Size of tuple", 5 * LayoutFactory.DS, ip2_layout.byteOrBitSize());
        assertEquals("Align of tuple", LayoutFactory.DA, ip2_layout.byteAlign());

        Location<IP2> loc = ip2_layout.allocate();
        Double[] a = {2.0,3.0,4.0,5.0};
        loc.put(new IP2(1.0, a));
        IP2 ip = loc.val();
    ...
    public void testTupleWithPrimitive() {
        ...
        assertEquals("Size of tuple", 2 * LayoutFactory.DS, ip3_layout.byteOrBitSize());
        assertEquals("Align of tuple", LayoutFactory.DA, ip3_layout.byteAlign());
