...
public final class OpaquePointerLayout<T> extends PointerLayout<T> {

    OpaquePointerLayout(Class<T> cls) {
        super(cls);
    ...
    T val(Location arena, Object base, long l) {
        ...
        return cls().cast( pd.fromOpaque(base, asNative) );
    }

    @Override
    void put(Location arena, Object base, long l, T v) {
        PointerDomain pd = arena.pointerDomain();
        long asNative = pd.toOpaque(v);
