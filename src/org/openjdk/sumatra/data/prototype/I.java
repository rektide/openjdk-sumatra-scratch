...
/**
 * A layout for a 32-bit integer, in a 32-bit container.
 * @author dr2chase
 */
public final class I extends AtomLayout<Integer> {
    ...
    private static int getBox(Object base, long offset) {
        return u.getInt(base, offset);
    }

    @SuppressWarnings("restriction")
    private static void putBox(Object base, long offset, int val) {
        u.putInt(base, offset, val);
    }

    I(Class cl, int s, int a) {
        super(s, a, cl);
    }

    // NOT PUBLIC, but visible to Location
    int prim(Object base, long l) {
        return getBox(base, l);
    }

    // NOT PUBLIC, but visible to Location
    void putPrim(Object base, long l, int v) {
        putBox(base, l, v);
    }

    // NOT PUBLIC, but visible to Location
    @Override
    Integer val(Object base, long l) {
        return new Integer(prim(base, l));
    }

    // NOT PUBLIC, but visible to Location
    @Override
    void put(Object base, long l, Integer v) {
    ...
    @Override
    void fillArray(Location arena, Object base, long addr, Integer[] a) {
        int count = a.length;
        for (int i = 0; i < count; i++) {
            a[i] = Integer.valueOf(prim(base, addr));
            addr += byteOrBitSize();
        }
    }
    ...
    @Override
    AtomBitLayout<Integer> bitsWideLE(int b) {
        if (b < 0) { // Signed
            b = -b;
            if (b > BITS_PER_BOX)
    ...
    @Override
    AtomBitLayout<Integer> bitsWideBE(int b) {
        if (b < 0) { // Signed
            b = -b;
            if (b > BITS_PER_BOX)
                throw new Error("Improper bit offset (negative of) " + -b);
    ...
    abstract public static class Bit extends  AtomBitLayout<Integer> {
        @Override
        ...
        Bit(int s, int mask) {
            super(s, 0, Integer.class);
            storeMask = mask;
        }

        abstract int prim(Object base, long l, long b);
        abstract void putPrim(Object base, long l, long b, int v);
        ...
        // NOT PUBLIC, but visible to Location
        @Override
        Integer val(Object base, long l, long b) {
            return new Integer(prim(base, l, b));
        }

        // NOT PUBLIC, but visible to Location
        @Override
        void put(Object base, long l, long b, Integer v) {
            putPrim(base, l, b, v.intValue());
        }
        ...
        void fillArray(Location arena, Object base, long addr, Integer[] a) {
            ...
            long bump = byteOrBitSize();
            for (int i = 0; i < count; i++) {
                a[i] = Integer.valueOf(prim(base, addr, offset));
                offset += bump;
            }
        }
        ...
        @Override
        final Layout<Integer> atFixedOffset(int b) {
    ...
    abstract static class BitLE extends  Bit {
        ...
        // NOT PUBLIC, but visible to Location
        @Override
        final void putPrim(Object base, long l, long b, int v) {
    ...
    public final static class BitLEUnsigned extends BitLE {
        ...
        @Override
        final int prim(Object base, long l, long b) {
            ...
            if (before_bits_above >= 0) {
                int container = getBox(base, l) << before_bits_above;
    ...
    static abstract class BitBE extends Bit {
        ...
        // NOT PUBLIC, but visible to Location
        @Override
        void putPrim(Object base, long l, long b, int v) {
            l += (b >>> LOG_BITS_PER_BOX) << (LOG_BITS_PER_BOX - LOG_BITS_PER_BYTE);
    ...
    public final static class BitBEUnsigned extends BitBE {
        ...
        // NOT PUBLIC, but visible to Location
        @Override
        int prim(Object base, long l, long b) {
            ...
            if (ib >= 0) {
                ...
                ib = -ib;
                int container = getBox(base, l);
                int other_container = getBox(base, l+BYTES_PER_BOX) ;
        ...
        @Override
        final BitAt newBitAt(int bit_offset) {
            return new BitAtUnsigned(this, BITS_PER_INT - bit_offset - (int) byteOrBitSize());
        }
    ...
    public final static class BitBESigned extends BitBE {
        ...
        int prim(Object base, long l, long b) {
            ...
            if (ib >= 0) {
                // left shift
                int container = getBox(base, l) << ib0;
                // Assume bitfields do not span an int-sized boundary.
        ...
        @Override
        final BitAt newBitAt(int bit_offset) {
            return new BitAtSigned(this, BITS_PER_INT - bit_offset - (int) byteOrBitSize());
        }
     ...
     * @author dr2chase
     */
    abstract public static class BitAt extends Layout<Integer> {
        ...
        // NOT PUBLIC, but visible to Location
        abstract int prim(Object base, long l);

        // NOT PUBLIC, but visible to Location
        final void putPrim(Object base, long l, int v) {
        ...
        // NOT PUBLIC, but visible to Location
        @Override
        final Integer val(Object base, long l) {
            return new Integer(prim(base, l));
        }

        // NOT PUBLIC, but visible to Location
        @Override
        final void put(Object base, long l, Integer v) {
            putPrim(base, l, v.intValue());
        }

        @Override
        final void fillArray(Location arena, Object base, long addr, Integer[] a) {
            throw new UnsupportedOperationException(
